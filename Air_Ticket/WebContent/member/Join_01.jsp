					...
					<ul>
						<li>
							...
							<div class="terms_area">
								...
								<h3>제1장 총칙</h3>
								<p>제1조 [목적]</p>
								본 약관은 '에어나인 주식회사 (이하 "에어나인"라고 합니다.)' 에서 운영하는 에어나인 유무선 웹사이트
								(flyairseoul.com 및 모바일 APP 등)가 제공하는 인터넷 관련 서비스를 이용함에 있어 에어나인과
								이용자간 권리ㆍ의무 및 기타 책임사항 등에 대하여 규정함을 목적으로 합니다.
								<p>제2조 [용어의 정의]</p>
								① "에어나인 웹사이트"란 에어나인이 상품 또는 서비스를 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를
								이용하여 상품 등을 거래할 수 있도록 설정한 가상의 영업장을 말합니다.<br> ② "이용자" 란 에어나인
								웹사이트에 접속하여 본 약관에 따라 에어나인이 제공하는 서비스를 받는 회원 또는 비회원을 말합니다.<br>
								③ "회원"이라 함은 에어나인 웹사이트에 개인정보를 제공하고 아이디 및 비밀번호를 등록한 자로서, 에어나인의
								웹사이트가 지속적으로 제공하는 정보 및 서비스를 계속적으로 이용할 수 있는 자를 말합니다.<br> ④
								"비회원"이라 함은 회원으로 가입하지 않고 에어나인이 제공하는 정보 및 서비스를 이용하는 자를 말합니다.
								<p>제3조 [약관의 게시 및 개정]</p>
								① 에어나인은 본 약관의 내용과 상호,연락처(전자우편주소, 전화번호, 팩스번호 등), 통신판매업신고번호 등을
								에어나인 웹사이트 초기 화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할
								수 있습니다.<br> ② 에어나인은 '전자상거래등에서의 소비자보호에 관한 법률', '약관의 규제에 관한
								...
								적용에 대하여 개정약관 적용일 이전까지 에어나인에 명시적으로 거부의 의사를 표시하는 경우, 해당 회원에 한하여 개정
								...
								<h3>제2장 서비스 이용</h3>
								<p>제4조 [서비스의 제공]</p>
								① 에어나인은 웹사이트를 통하여 제공하는 서비스는 아래와 같습니다. 1. 항공권 예매 및 관련 정보, 서비스 제공
								2. 에어텔, 호텔,렌터카 등 여행 상품 관련 정보, 서비스 제공 3. 기타 에어나인이 정하는 업무<br>
								② 에어나인은 필요한 경우 전항의 서비스의 내용을 임의로 추가, 조정 등변경하여 적용할 수 있습니다.
								<p>제5조 [서비스의 이용 및 제한]</p>
								① 에어나인은 컴퓨터 등 정보통신설비의 보수점검, 교체 및 고장, 시스템의 고장, 통신두절 등의 사유가 발생한 경우
								서비스의 제공을 일시적으로 중단할 수 있습니다.<br> ② 제1항에 의한 서비스 제공의 경우 에어나인은
								제10조에 정한 방법으로 이용자에게 통지하며, 이용자 또는 제3자가 입은 손해에 대하여는 배상하지 아니합니다. 단,
								에어나인에 고의 또는 중과실이 있는 경우에는 그러하지 아니합니다.<br> ④ 에어나인이 제공하는 인터넷
								서비스의 일부는 flyairseoul.com에 회원으로 가입한 경우에 한하여 이용될 수 있습니다.<br>
								⑤ 에어나인은 이용자가 다음 각 호의 1에 해당하는 행위를 한 경우 사전통지 없이 서비스이용을 차단하거나 중지할 수
								...
								법령이나 에어나인이 약관에서 정한 이용규칙을 위배하는 행위<br> ⑥ 전 제5항에 의한 서비스 이용이
								중지된 경우, 에어나인은 이용자 또는 제 3자가 입은 손해를 배상하지 아니합니다.
								<p>제6조 [회원의 가입]</p>
								...
								성립 시기는 에어나인의 승낙이 회원에게 도달한 시점으로 합니다.<br> ⑤ 회원은 제 14조 제 1항에
								...
								① 에어나인 웹사이트 서비스를 이용하고자 하는 회원은 에어나인이 정하는 바에 따라 회원ID 및 Password를
								등록하여야 합니다.<br> ② 회원 ID와 Password에 관한 관리책임은 회원 본인에게 있으므로 회원은
								자신의 ID 및 Password를 제3자에게 알려주거나 이용하게 해서는 안됩니다.<br> ③ 회원이 자신의
								ID 또는 Password를 도난 당하거나 제3자가 사용하고 있음을 인지한 경우에는 즉시 에어나인에 통보하고
								에어나인의 안내가 있는 경우에는 그에 따라야 합니다.
								<p>제 8조 [회원탈퇴와 자격의 상실]</p>
								① 회원은 언제든지 탈퇴신청을 할 수 있으며, 이 경우 에어나인은 즉시 회원탈퇴를 처리합니다.<br> ②
								회원이 다음 각 호에 해당하는 경우에는 에어나인은 서비스이용을 제한 또는 자격을 상실시킬 수 있습니다. <br>&nbsp;&nbsp;&nbsp;
								1. 회원 사망 시 <br>&nbsp;&nbsp;&nbsp; 2. 가입 신청 시 허위의 내용을 기재하거나
								2개 이상의 ID로 이중 등록한 경우 <br>&nbsp;&nbsp;&nbsp; 3. 타인의 서비스 이용을
								방해하거나 타인의 개인정보를 도용하는 등 전자거래질서를 침해·위협하는 경우 <br>&nbsp;&nbsp;&nbsp;
								4. 에어나인 웹사이트에서 구매한 항공권 등의 대금 지급 채무 및 기타 에어나인 웹사이트에서 제공한 서비스를
								이용하고 이에 대응한 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 채무를 불이행한 경우 <br>&nbsp;&nbsp;&nbsp;
								5. 에어나인 웹사이트를 통해 본 약관이 금지하는 행위를 하거나 법령, 기타 공서양속에 반하는 행위를 하는 경우 <br>&nbsp;&nbsp;&nbsp;
								6. 회원 가입 후 1년 동안 에어나인 웹사이트에 로그인 한 기록이 없는 경우<br> ③ 에어나인이 서비스
								이용을 제한·정지하고자 할 때에는 미리 그 사유, 일시, 기간을 전자우편, 전화, 서면 등으로 이용자에게
								통지합니다. 다만 긴급을 요할 경우에는 조치 후에 통지할 수 있습니다. <br>④ 에어나인이 서비스이용을
								제한·정지시킨 후 그 제재사유가 된 행위가 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 에어나인은
								회원자격을 상실시킬 수 있습니다. <br>⑤ 에어나인은 전항의 사유로 인하여 회원이 자격을 상실하여
								...
								의거 통지합니다. <br>⑥ 서비스이용의 제한, 정지, 회원자격의 상실로 인한 손해에 대해서 에어나인은
								책임을 지지 않습니다.
								<p>제 9조 [회원에 대한 통지]</p>
								① 에어나인이 회원에 대한 통지를 하는 경우 회원이 제출한 전자우편주소, 무선 단문 메시지 (알림톡 또는 SMS)
								등을 이용할 수 있습니다. <br>② 에어나인은 불특정 다수의 회원에게 통지하는 경우에는 에어나인
								웹사이트에7일 이상 공시함으로써 개별 통지를 갈음할 수 있습니다. <br>③ 제 2항의 사유로 통지하는
								경우, 부득이한 사정에 의해 사전 공시 기간이 감축되거나 생략될 수 있습니다.
								<p>제 10조 [정보의 제공]</p>
								에어나인은 회원에게 서비스 이용 및 각종행사(상업성 광고), 여행정보 등 다양한 서비스를 전자우편이나, 서신,
								무선단문 메시지(알림톡 혹은 SMS)발송 등의 방법으로 제공할 수 있습니다. 단, 제공을 원치 않는 회원은
								에어나인이 제공하는 정보에 대하여 수신 거부할 수 있습니다
								<p>제 11조 [항공권 등에 대한 구매 신청]</p>
								① 이용자는 에어나인이 정한 방식에 따라 항공권 등의 구매 신청을 할 수 있습니다. <br>&nbsp;&nbsp;&nbsp;
								1. 성명,성별,연락처 등 입력입력 <br>&nbsp;&nbsp;&nbsp; 2. 개인정보 수집 및
								규정,법적고지문,약관 등에 동의한다는 표시 (예,마우스클릭) <br>&nbsp;&nbsp;&nbsp; 3.
								결제수단 선택
								<p>제 12조 [구매 계약의 성립]</p>
								② 에어나인은 제 11조에서 정한 방법의 구매 신청에 대하여 다음 각호에 해당할 경우 승낙하지 않을 수 있습니다.
								<br>&nbsp;&nbsp;&nbsp; 1.신청 내용에 허위, 기재누락, 오기가 있는 경우 <br>&nbsp;&nbsp;&nbsp;
								2.구매신청에 대한 승낙이 영업상 또는 기술상 현저히 지장이 있다고 판단되는 경우 <br>③ 에어나인의
								승낙이 수신확인통지형태로 이용자에게 도달한 때에 계약이 성립한 것으로 봅니다. <br>④ 전항의
								수신확인통지를 받은 이용자는 신청한 내용에 대하여 구매신청을 취소하거나 변경을 요청할 수 있으며, 에어나인은 이에
								따라 처리합니다.
								<p>제 13조 [결제방법]</p>
								에어나인 웹사이트에서 구매한 재화.용역에 대한 대금지급방법은 다음 각 호의 하나로 할 수 있습니다. <br>&nbsp;&nbsp;&nbsp;
								1.신용카드결제 <br>&nbsp;&nbsp;&nbsp; 2.실시간 계좌이체 <br>&nbsp;&nbsp;&nbsp;
								3.간편 결제 <br>&nbsp;&nbsp;&nbsp; 4.기타 에어나인이 정한 결제방식
								<h3>제3장 정보의 보호</h3>
								<p>제 14조 [개인정보 보호]</p>
								① 에어나인은 이용자로부터 정보를 수집할 경우 서비스의 제공 및 계약이행에 필요한 최소한의 정보만을 수집합니다. <br>②
								개인정보보호에 관한 상세한 내용은 에어나인 웹사이트상의 개인정보취급방침에서 규정한 바에 따릅니다.
								<h3>제 4장 책임과 의무</h3>
								<p>제 15조 [에어나인의 의무]</p>
								① 에어나인은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 이 약관이 정하는 바에 따라
								지속적이고 안정적인 서비스 제공 및 재화·용역의 공급에 노력합니다. <br>② 에어나인은 이용자가 안전하게
								서비스를 이용할 수 있도록 개인정보(신용정보 포함)에 관한 보안을 철저히 하며, 이를 위한 기술적 안전조치를
								강구하고, 관리에 만전을 기하겠습니다. <br>③ 에어나인은 에어나인 웹사이트에 대한 공정하고 건전한
								운영을 통하여 전자상거래질서를 유지하고, 지속적인 연구•개발을 통하여 양질의 서비스가 제공되도록 노력하겠습니다. <br>④
								에어나인은 웹사이트를 통해 제공되는 상품이나 서비스에 대하여 [표시광고의 공정화에 관한 법률] 제 3조 소정의
								부당한 표시·광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다. <br>⑤
								에어나인 웹사이트에 입점한 제휴사의 상품 또는 서비스의 판매는 해당 제휴사의 책임하에 직접 이루어지며 에어나인은 동
								사이트를 통한 중개 역할만을 수행합니다.
								<p>제 16조 [이용자의 의무]</p>
								① 이용자는 이 약관 및 관계법령을 준수하여야 하며, 다음의 행위를 해서는 안됩니다. <br>&nbsp;&nbsp;&nbsp;
								1. 신청 또는 변경 시 허위내용의 기재 <br>&nbsp;&nbsp;&nbsp; 2. 에어나인 웹사이트에
								게시된 정보의 임의변경 <br>&nbsp;&nbsp;&nbsp; 3. 에어나인이 허용하고 있지 않은 정보나
								컴퓨터 프로그램 등을 무단으로 송신 또는 게시하는 행위 <br>&nbsp;&nbsp;&nbsp; 4.
								에어나인 기타 제3자의 저작권 등 지적재산권 침해 <br>&nbsp;&nbsp;&nbsp; 5. 에어나인
								기타 제3자의 명예, 프라이버시를 침해하거나 업무를 방해하는 행위 <br>&nbsp;&nbsp;&nbsp;
								6. 외설적 또는 폭력적 메시지·화상·음성 기타 공서양속에 반하는 정보를 송신, 공개 또는 게시하는 행위<br>
								② 전항 각호의 정보 기타 운영상 부적절하다고 판단한 정보가 에어나인 웹사이트에 게시되거나 링크된 경우 에어나인은
								이용자 기타 정보게시자의 동의 없이 당해 정보를 삭제하거나 링크를 차단할 수 있습니다.
								<p>제 17조[에어나인 웹사이트와 타 웹사이트간의 관계 등]</p>
								① 에어나인 웹사이트와 연결 사이트가 하이퍼링크 (예: 하이퍼링크의 대상에는 문자, 그림 및 동화상 등이
								해당)방식으로 연결된 경우, 에어나인은 피연결 웹사이트가 독자적으로 제공하는 재화나 용역 등에 대하여는 보증책임을
								부담하지 아니합니다. <br>② 에어나인은 이용자가 에어나인 웹사이트의 게시판 등에 게재한 정보나 자료
								등에 관하여 신뢰성을 담보하지 아니하며, 그로 인하여 손해가 발생하더라도 책임을 지지 아니합니다.
								<h3>제5장 기타</h3>
								<p>제 18조[저작권의 귀속]</p>
								① 에어나인이 작성한 저작물에 대한 저작권 기타 지적재산권은 에어나인에 귀속합니다.<br> ② 이용자는
								에어나인 웹사이트를 통해 얻은 정보 중 에어나인에 지적재산권이 귀속된 정보에 대하여는 에어나인의 사전 동의 없이
								복제,송신,출판,배포,방송 기타 방법으로 영리목적에 이용하거나 제3자의 이용에 제공할 수 없습니다. 제
								<p>19조[분쟁의 해결]</p>
								① 에어나인은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 피해에 대한 보상처리를 위하여 피해보상처리기구를
								설치.운영합니다.<br> ② 에어나인은 이용자가 제기하는 불만사항 및 의견을 신속·적정하게 처리합니다.
								다만 신속한 처리가 곤란한 경우에는 이용자에게 그 사유와 처리일정을 지체 없이 통보해 드립니다.<br> ③
								에어나인과 이용자간에 전자거래에 관한 분쟁 발생시 전자거래기본법 및 동법 시행령에 근거 하여 설치된
								전자거래분쟁조정위원회의 조정에 따를 수 있습니다.
								<p>제 20조[관할법원 및 준거법]</p>
								① 에어나인과 이용자는 서비스이용과 관련하여 발생한 분쟁에 대하여 상호 원만하게 처리될 수 있도록 필요한 모든
						...
						<li class="limagin">
							...
							<div class="terms_area">
								...
								본 개인정보취급방침은 에어나인㈜ (이하 ‘에어나인’이라 한다)의 인터넷 홈페이지 flyairseoul.com 을
								이용하는 회원 혹은 비회원(이하 통칭하여 “이용자”라 한다)의 개인정보에 대한 관리 및 운영에 관한 내용입니다.
								에어나인은 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 정보통신서비스 제공자가 준수하여야 할 관련 법령상의
								개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보취급방침을 정하여 이용자 권익 보호에 최선을 다하고
								있습니다. 에어나인의 홈페이지 개인정보취급방침은 다음과 같습니다. <br>
								<br>
								<br>
								<br>
								<br>
								...
								<p>1) 수집하는 개인정보 항목</p>
								에어나인은 이용자에게 회원가입, 원활한 고객상담, 각종 서비스의 제공을 위하여 아래와 같은 개인정보를 수집하고
								있습니다. (1) 에어나인 홈페이지 회원 가입 시 ① 필수항목 : 한글 및 영문 성명, 성별, 전화번호, 이메일,
								...
								로그, 쿠키, 접속 IP 정보, 결제기록
								<p>2) 개인정보 수집 방법</p>
								에어나인은 홈페이지의 회원가입, 고객센터, 게시판, 이벤트 참여를 통해 개인정보를 수집합니다. 이용자는 에어나인이
								...
								1) 에어나인은 법령에 근거가 있거나 정부의 관련 방침, 지시 등 예외적인 경우를 제외하고는 이용자의 사전 동의없이
								이용자의 개인정보를 본 지침상의 정보이용 목적의 범위를 넘어 사용하거나 제3자에게 제공하지 않습니다.<br>
								2) 다만, 회원께서 제휴사 등의 서비스를 이용시 원활한 서비스 제공을 위하여 최소한의 개인정보가 제공될 수
								있으며, 그러한 경우 에어나인은 제공할 정보의 내용 및 목적, 제공받는 자, 보유기간을 사전에 전자우편이나 서면으로
								개별 통지하거나, 홈페이지상 해당 내용을 명시하여 회원 동의를 받고 있습니다.
								<h3>4. 개인정보의 취급 위탁</h3>
								에어나인은 원활한 서비스 제공을 위하여 아래와 같이 개인정보를 위탁하여 운영하고 있으며, 관계 법령에 따라 위탁계약
								시 개인정보가 안전하게 관리될 수 있도록 필요한 사항을 규정하고 있습니다. 개인정보 위탁처리 기관 및 위탁업무
								내용은 아래와 같습니다.<br> <img src="img/info.png">
								<h3>5. 개인정보의 보유 및 이용기간</h3>
								1) 이용자가 제공한 개인정보는 에어나인이 제공하는 서비스를 받는 동안 에어나인이 보유ㆍ이용하게 됩니다.<Br>
								2) 에어나인은 회원이 탈퇴하거나 자격을 상실하는 경우 또는 수집 목적을 달성하거나 사업을 폐업하는 경우에는 회원
								...
								기타 보유 정보: 정보의 수집 및 이용 목적이 달성된 때<br> 3) 에어나인은 1년간 홈페이지 로그인
								...
								1) 에어나인은 만14세 미만 아동으로부터 개인정보를 수집하거나, 이미 수집된 정보를 제3자에게 제공하거나 동의
								...
								에어나인은 이용자의 정보를 자동으로 저장하고 찾아내는 ‘쿠키(cookie)’ 등을 운용합니다. 쿠키란 웹사이트를
								...
								<h3>10. 의견 및 불만처리</h3>
								<br>에어나인은 개인정보보호와 관련하여 이용자에게 자유롭게 의견을 개진하고 불만을 토로할 수 있는 창구를
								개설하여 운영하고 있습니다. 아래 연락처로 의견이나 불만을 제기하시면 접수 즉시 조치하고, 그 처리결과를 통보하여
								드리겠습니다. <br>▷ 홈페이지 : 고객센터를 통하여 접수 바로가기 <br>▷ 에어나인 서비스
								센터 : 국번없이 1800-8100
								<h3>11. 홈페이지 개인정보 관리책임자</h3>
								<br>에어나인은 이용자의 개인정보에 대한 개인정보관리책임자를 지정하여 개인정보보호를 위해 최선을
								다하겠습니다. 현재 에어나인의 홈페이지 개인정보 관리책임자는 아래와 같습니다. <br>에어나인의 개인정보
								관리 책임은 에어나인 개인정보처리방침에 따릅니다. <img alt="" src="img/info2.png"><br>
								...
								<br>에어나인은 이용자에게 홈페이지를 통하여 다른 회사의 웹사이트 또는 자료에 대한 링크를 제공할 수
								있습니다. <br>이 경우 에어나인은 외부사이트 및 자료에 대하여 통제권이 없을 뿐만 아니라 이들이
								개인정보를 수집하는 행위에 대하여 에어나인의 '개인정보취급방침'이 적용되지 않습니다. <br>따라서,
								에어나인이 포함하고 있는 링크를 클릭하여 타 사이트의 페이지로 이동할 경우에는 새로 방문한 사이트의
						...
						<li class="limagin">
							...
							<div class="terms_area">
								에어나인에서는 항공여행정보시스템 제공 업체인 SITA사에 당사의 예약 및 운송 시스템 운영을 위탁하고 있으며,
